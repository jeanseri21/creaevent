      ...
      <div class="col-lg-8 vstack gap-4">
          ...
          <div class="h-200px rounded-top" style="background-image:url(assets/images/bg/05.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
            ...
            <div class="card-footer mt-3 pt-2 pb-0">
              ...
              <ul class="nav nav-bottom-line align-items-center justify-content-center justify-content-md-start mb-0 border-0">
                ...
                <li class="nav-item"> <a class="nav-link active" href="/myconnexion"> Connexions </a> </li>

                <li class="nav-item"> <a class="nav-link " href="/myevent"> Evenenement</a> </li>
        ...
        <div class="card">
          ...
          <div class="card-header d-sm-flex align-items-center justify-content-between border-0 pb-0">
            <h5 class="card-title mb-sm-0">Mes connexions</h5>
            <!-- Button modal -->
       ...
       <div class="d-md-flex align-items-center mb-4">
                ...
                <ul class="avatar-group mt-1 list-unstyled align-items-sm-center">
                  ...
                  <li class="small ms-3">
                    Carolyn Ortiz, Frances Guerrero, and 20 le suivre
                  </li>
                </ul>
                <!-- Connections END -->
              </div>
              ...
              <div class="ms-md-auto d-flex">
                <button class="btn btn-danger-soft btn-sm mb-0 me-2">Supprimer </button>
                <button class="btn btn-primary-soft btn-sm mb-0"> Rdv </button>
              </div>
            </div>
</div>
            </div>
